                ...
                <div className="w-full flex flex-col gap-[40px] px-[20px] py-[40px] xl:px-[30px]">
                    <div className="flex justify-between">
                        <div className="w-full flex flex-col items-center">
                            <h2 className="font-bold xl:text-[2.2rem] text-[1.6rem] mb-[10px] text-center text-black">
                                Who We <span className="font-bold text-[#1DBF73]">Serve</span>
                            </h2>
                            <p className="text-lg text-[#222222] text-center lg:w-[60%] mx-auto">
                    ...
                    <Link to={`/signup`} className="text-[#1DBF73] border-[#1DBF73] bg-[#1dbf7327] border rounded-[8px] w-fit px-[20px] py-[10px] mx-auto font-bold xl:text-[1rem] text-[.9rem]">Explore the market</Link>

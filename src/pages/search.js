                            ...
                            {filter === "bond" ? <>
                                    ...
                                    <table className="min-w-full xl:table hidden table-auto bg-white pb-[30px]  rounded-[20px]  border-collapse">
                                        ...
                                        <thead>
                                            <tr className="bg-[#FDFBFD]">
                                                ...
                                                <th className="p-[10px] bg-[#1DBF7314] text-[1.07rem] font-medium text-left border-b lg:py-[30px] border-gray-300">Status</th>
                                            ...
                                            {currentRows?.map((bond, index) => (
                                                <div key={index} className="p-[20px] bg-white flex flex-col gap-[20px] border-b border-gray-300 py-4">
                                                    ...
                                                    <div className="flex flex-col gap-[10px]">
                                                        ...
                                                        <div className="flex items-center  gap-[10px]">
                                                            <h1 className="text-[0.75rem] ">Status:</h1>
                                                            <p className="text-[0.75rem] ">{bond?.status}</p>
                                                        </div>
                                ...
                                <div className="lg:p-[30px] lg:bg-white">
                                    <table className="min-w-full xl:table hidden table-auto border-gray-300 border-collapse">
                                        <thead>
                                            <tr className="bg-[#FDFBFD]">
                                                <th className="p-[10px] bg-[#1DBF7314]  text-[1.07rem] font-medium lg:px-[30px] lg:py-[30px] text-left border-b border-gray-300">Name</th>
                                                <th className="p-[10px] bg-[#1DBF7314] text-[1.07rem] font-medium text-left border-b lg:py-[30px] border-gray-30">Email</th>
                                                <th className="p-[10px] bg-[#1DBF7314] text-[1.07rem] font-medium text-left border-b lg:py-[30px] border-gray-30">Location</th>
                                                <th className="p-[10px] bg-[#1DBF7314] text-[1.07rem] font-medium text-left border-b lg:py-[30px] border-gray-30">Joined On</th>
                                                <th className="p-[10px] bg-[#1DBF7314] text-[1.07rem] font-medium lg:pr-[30px] text-left lg:py-[30px] border-b border-gray-300">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {currentRows?.map((bond, index) => (
                                                <tr key={index}>
                                                    <td className="p-[10px] lg:pl-[30px] text-[0.94rem] border-b border-b-[#E9E9E9]  font-normal pt-[30px]">{bond?.user_id?.username}</td>
                                                    <td className="p-[10px] lg:pl-[30px] text-[0.94rem] border-b border-b-[#E9E9E9]  font-normal pt-[30px]">{bond?.user_id?.email}</td>
                                                    <td className="p-[10px] lg:pl-[30px] text-[0.94rem] border-b border-b-[#E9E9E9]  font-normal pt-[30px]">{bond?.user_id?.location ? bond?.user_id?.location : 'Location not registered'}</td>
                                                    <td className="p-[10px] lg:pl-[30px] text-[0.94rem] border-b border-b-[#E9E9E9]  font-normal pt-[30px]">
                                                    ...
                                                    <td className={`flex  p-[20px] items-center gap-[6px] border-b border-b-[#E9E9E9]`}>
                                                        <Link to={`/profile?id=${bond?._id}`} className="flex bg-[#FFEDE8] p-[20px] items-center gap-[6px]">View</Link>
                                                    </td>
                                                </tr>
                                            ))}
                                        </tbody>
                                        ...
                                        <div className="flex bg-[#f2f2f2] flex-col gap-[20px]">
                                            {currentRows?.map((bond, index) => (
                                                <div key={index} className="p-[20px] bg-white flex flex-col gap-[20px] border-b border-gray-300 py-4">
                                                    <div className="flex flex-col gap-[10px]">
                                                        <div className="flex flex-col gap-[10px]">
                                                            <p className="text-[14px] font-semibold">{bond?.user_id?.username}</p>
                                                        </div>
                                                        <div className="flex flex-col gap-[10px]">
                                                            <p className="text-[14px] font-semibold">{bond?.user_id?.email}</p>
                                                        </div>
                                                        <div className="flex flex-col gap-[10px]">
                                                            <p className="text-[14px] font-semibold">{bond?.user_id?.location ? bond?.user_id?.location : 'Location not registered'}</p>
                                                        </div>
                                                        <div className="flex flex-col gap-[10px]">
                                                            <p className="text-[14px] font-semibold"> {bond?.user_id?.createdAt
                                                                ? new Date(bond.user_id.createdAt).toLocaleDateString('en-US', {
                                                                    month: 'long',
                                                                    day: 'numeric',
                                                                    year: 'numeric',

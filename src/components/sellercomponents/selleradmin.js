                    ...
                    <div className="flex flex-col gap-[10px]">
                        ...
                        >
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6 13V15M10 9V15M14 5V15M5.8 19H14.2C15.8802 19 16.7202 19 17.362 18.673C17.9265 18.3854 18.3854 17.9265 18.673 17.362C19 16.7202 19 15.8802 19 14.2V5.8C19 4.11984 19 3.27976 18.673 2.63803C18.3854 2.07354 17.9265 1.6146 17.362 1.32698C16.7202 1 15.8802 1 14.2 1H5.8C4.11984 1 3.27976 1 2.63803 1.32698C2.07354 1.6146 1.6146 2.07354 1.32698 2.63803C1 3.27976 1 4.11984 1 5.8V14.2C1 15.8802 1 16.7202 1.32698 17.362C1.6146 17.9265 2.07354 18.3854 2.63803 18.673C3.27976 19 4.11984 19 5.8 19Z" stroke={`${location.pathname === '/buyerdashboard' ? '#2563EB' : 'white'}`} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
...
localStorage.removeItem("buyerToken")
                ...
                <div className="xl:w-[80%] w-full gap-[20px] px-[20px] py-[40px] flex flex-col">
                    <div className="w-full rounded-[10px] px-[20px] py-[20px] flex justify-between items-center bg-white">
                        ...
                        <h1 className="text-[#2563EB] text-[24px] font-semibold xl:flex hidden">
                            {location.pathname
                                .replace('/', '')
                                .split('/')[0]

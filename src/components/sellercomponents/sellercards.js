            ...
            {loading ? <div className='flex justify-center items-center'>
                ...
                <div className="bg-white rounded-[20px] p-[20px] flex gap-[10px] custom-inset-shadow">
                    ...
                    <div className="flex flex-col">
                        <h1 className="text-[16px] text-[#344054]">TotalBonds Owned</h1>
                        <h2 className="text-[18px] font-semibold">{state?.bondList?.length}</h2>
                    </div>
                </div>
                <div className="bg-white rounded-[20px] p-[20px] flex gap-[10px] custom-inset-shadow">
                    <div className="flex justify-center items-center p-[20px] rounded-[20px] bg-[#C0A3FC]">
                    ...
                    <div className="flex flex-col">
                        <h1 className="text-[16px] text-[#344054]">Pending Sales</h1>
                ...
                <div className="bg-white rounded-[20px] p-[20px] flex gap-[10px] custom-inset-shadow">
                    ...
                    <div className="flex flex-col">
                        ...
                        <h2 className="text-[18px] font-semibold">{filterBondCount("WAITING FOR EXCHANGE")}</h2>
                    </div>
                </div>
            </>}
        </div>

        ...
        filteredBonds?.map((bond, i) => {
            ...
            return (
                <div
                    ...
                    key={bond?._id}
                    className="bg-white cursor-pointer relative h-[450px] border-[#E9E9E9] border rounded-[20px] flex flex-col gap-[20px] overflow-hidden"
                >
                    
                    <img
                        src={
                            bond?.photos[0]?.replace(
                                "http://localhost:5000",
                                BASE_URL
                            ) || `${BASE_URL}/defaultImage.webp`
                        }
                        alt="cardimg"
                    ...
                    <div className="flex px-[20px] pb-[20px] justify-between">
                        ...
                        <span className="lg:text-[1.25rem] text-[1rem]">
                            <span className="text-[#74767E] font-normal text-[.8rem] pr-[2px]">
                                Starting at:
                            </span>
                            ${bond?.bond_issuerance_amount}
                        </span>
                    </div>
                </div>
            );

                    ...
                    filteredBonds?.map((bond, i) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="text-[0.88rem] px-[20px] text-[#74767E]">
                                    {bond?.title}
                                </p>
                                <p className="text-[1.1rem] px-[20px] ">
                                ...
                                <div className="flex px-[20px] pb-[20px] justify-between">
                                    <div className="flex gap-[10px] text-[0.88rem]">
                                        <img
                                    ...
                                    <span className="text-[0.88rem]">
                                        <span className="text-[#74767E] font-normal text-[0.88rem] pr-[2px]">
                                            Starting at:
                                        </span>

                        ...
                        <div className="bg-white flex flex-col gap-[10px] rounded-[20px] p-[20px] max-w-[800px] w-full">
                            ...
                            <div className="mt-[10px]">
                                ...
                                >
                                    ...
                                    <option value="promoting">Promoting the products or services of bond purchasers during live broadcasts.</option>
                                    <option value="sponsoring">Sponsoring offline events with bond purchasers.</option>
                                    <option value="videos">Creating promotional videos and posting them on their own social media.</option>
                                    <option value="providing">Providing products, service vouchers, or gift certificates of higher value than the bond issuance price.</option>
                                </select>

...
export default function UserInfo({ state, loading }) {
    return (
            ...
            {loading ? <div className='flex justify-center items-center'>
                ...
                <div className="flex items-center gap-[20px] mx-auto">
                    ...
                    <div className="flex flex-col">
                        ...
                        <h2 className="text-[18px] text-[#344054] ">Influencer</h2>
                    </div>
                </div>
                <div className="flex flex-col gap-[20px]">
                    <div className="flex items-center justify-between w-full">
                        <div className="flex flex-col">
                            <h1 className="text-[20px] font-semibold">120K</h1>
                            <h2 className="text-[18px] text-[#344054] ">Followers</h2>
                        </div>
                        <div className="flex flex-col">
                            <h1 className="text-[20px] font-semibold">12</h1>
                            <h2 className="text-[18px] text-[#344054] ">Level</h2>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col">

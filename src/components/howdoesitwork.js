    ...
    return (
        <div className="w-full  px-[20px] py-[40px] xl:px-[40px] flex flex-col gap-[20px]">
            <div className="flex justify-between">
                ...
                <Link to="/howitworks" className="lg:flex items-center lg:text-[0.94rem] text-[0.75rem] mt-[40px] gap-[5px] hidden text-center">
                    See more
                    <svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.43 0.930054L18.5 7.00005L12.43 13.0701" stroke="#222222" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M1.5 7H18.33" stroke="#222222" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </Link>
            </div>
            <div className="grid gap-[20px] md:grid-cols-3 lg:mt-[5.63rem] grid-cols-1">
                <div className="bg-white px-[20px] lg:h-[175px] flex flex-col gap-[10px] rounded-[20px]">
                    ...
                    <span className="lg:text-[1.25rem] text-[1rem] font-semibold lg:mt-[20px]">Sign Up</span>
                    <p className="lg:text-[1.44rem] text-[0.75rem] text-[#6B7177]">Join our platform in minutes with email and phone verification.</p>
                ...
                <div className="bg-white px-[20px] lg:h-[175px] flex flex-col gap-[10px] rounded-[20px]">
                    ...
                    <span className="lg:text-[1.25rem] text-[1rem] font-semibold lg:mt-[20px]">Issue Promise Bonds</span>

                    <p className="lg:text-[1.44rem] text-[0.75rem] text-[#6B7177]">Describe your mission, set a price, and get operator approval.</p>
                </div>
                ...
                <div className="bg-white px-[20px] lg:h-[175px] flex flex-col gap-[10px] rounded-[20px]">
                    ...
                    <span className="lg:text-[1.25rem] text-[1rem] font-semibold lg:mt-[20px]">Promote & Sell</span>

                    <p className="lg:text-[1.44rem] text-[0.75rem] text-[#6B7177]">Share your bond on social media and start earning.</p>
                </div>

            </div>
            <Link to="/howitworks" className="flex items-center lg:text-[0.94rem] text-[0.75rem] mx-auto  mt-[40px] gap-[5px] lg:hidden text-center">
                See more
                <svg width="16" height="10" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.43 0.930054L18.5 7.00005L12.43 13.0701" stroke="#222222" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M1.5 7H18.33" stroke="#222222" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </Link>
